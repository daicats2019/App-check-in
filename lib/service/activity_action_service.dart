...
class ActivityActionService {
  ...
  static Future<ActivityModelToday?> checkActivityAction(String action,bool isCheckIn, String token) async {
    Response response;
    ...
    response = await dio.put('/api/v1/activities/action',data: {"action": action, "is_check_in": isCheckIn});
